...
from config import REMOTE_HOST, REMOTE_PATH_PHOTO, REMOTE_PATH_VIDEO, LOCAL_PATH, USERNAME
...
def fetch_files():
    ...
    ssh.connect(REMOTE_HOST, username=USERNAME)  # No password needed with SSH key
